...
public class AdminImagesActivityTest {
    ...
    @Rule
    public ActivityTestRule<AdminImagesActivity> rule =
            new ActivityTestRule<>(AdminImagesActivity.class, true, true);
    ...
    /**
     * Test if can switch back to AdminActivity from AdminImagesActivity by back Button
     */
    @Test
