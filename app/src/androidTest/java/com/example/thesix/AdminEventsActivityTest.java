...
public class AdminEventsActivityTest {
    ...
    @Rule
    public ActivityTestRule<AdminEventsActivity> rule =
            new ActivityTestRule<>(AdminEventsActivity.class, true, true);
    ...
    /**
     * Test if can switch back to AdminActivity from AdminEventsActivity by back Button
     */
    @Test
